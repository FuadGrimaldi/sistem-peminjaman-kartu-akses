...
<form action="{{ route('admin.kartu-akses.update', $kartuAkses->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="code" name="code" value="{{ old('code', $kartuAkses->code) }}" >
    </div>
    <div class="mb-3">
